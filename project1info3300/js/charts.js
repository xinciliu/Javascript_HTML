...
//Data Pull	
  ...
  //data from basketballreference.com, sourced from 1994/2015 Warriors, 2003/2014 Spurs, and 1985/2010 Lakers
...
Nsvg2.append("g").attr("class","axis").call(xAxis)
.attr("transform","translate(0,"+(height-margin)+")")
.append("text")
.text("wine_price")
.attr("transform","translate("+(height-margin)+",3)");
...
Nsvg2.append("path").attr("class", "path").attr("style", "stroke:" + "red" + ";stroke-width:4;fill:none;").attr("d", valuenew(evolve));
Nsvg2.append("path").attr("class", "path").attr("style", "stroke:" + "forestgreen" + ";stroke-width:4;fill:none;").attr("d", valuenew2p(evolve));
Nsvg2.append("path").attr("class", "path").attr("style", "stroke:" + "black" + ";stroke-width:4;fill:none;").attr("d", valueneworb(evolve));
Nsvg2.append("path").attr("class", "path").attr("style", "stroke:" + "purple" + ";stroke-width:4;fill:none;").attr("d", valuenewdrb(evolve));

//Legend - 3P
Nsvg2.append("line").attr("x1", xScale(2023.5)).attr("x2", xScale(2026.5)).attr("y1", yScale(0.6)).attr("y2", yScale(0.6)).attr("stroke", "red").text("3P%");
Nsvg2.append("circle").attr("cx", xScale(2025)).attr("cy", yScale(0.6)).attr("fill", "red").attr("r", 5);
Nsvg2.append("text").attr("x", xScale(2027)).attr("y", yScale(0.6)).attr("fill", "red").text("3P%").attr("font-size","12px").attr("font-family", "sans-serif").attr("font-weight", "bold");

//Legend - 2P
Nsvg2.append("line").attr("x1", xScale(2023.5)).attr("x2", xScale(2026.5)).attr("y1", yScale(0.55)).attr("y2", yScale(0.55)).attr("stroke", "forestgreen").text("2P%");
Nsvg2.append("circle").attr("cx", xScale(2025)).attr("cy", yScale(0.55)).attr("fill", "forestgreen").attr("r", 5);
Nsvg2.append("text").attr("x", xScale(2027)).attr("y", yScale(0.55)).attr("fill", "forestgreen").text("2P%").attr("font-size","12px").attr("font-family", "sans-serif").attr("font-weight", "bold");



//Legend - ORB
Nsvg2.append("line").attr("x1", xScale(2023.5)).attr("x2", xScale(2026.5)).attr("y1", yScale(0.5)).attr("y2", yScale(0.5)).attr("stroke", "black");
Nsvg2.append("circle").attr("cx", xScale(2025)).attr("cy", yScale(0.5)).attr("fill", "black").attr("r", 5);
Nsvg2.append("text").attr("x", xScale(2027)).attr("y", yScale(0.5)).attr("fill", "black").text("ORB%").attr("font-size","12px").attr("font-family", "sans-serif").attr("font-weight", "bold");

//Legend - DRB
Nsvg2.append("line").attr("x1", xScale(2023.5)).attr("x2", xScale(2026.5)).attr("y1", yScale(0.45)).attr("y2", yScale(0.45)).attr("stroke", "purple");
Nsvg2.append("circle").attr("cx", xScale(2025)).attr("cy", yScale(0.45)).attr("fill", "purple").attr("r", 5);
...
////////////////// 1985 Lakers
	...
	teamcomp.forEach((d,i) => {
		...
		var markerarray = [["3P%", "red"], ["2P%", "forestgreen"], ["ORB%","black"], ["DRB%", "purple"]];
